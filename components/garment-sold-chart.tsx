...
// const chartData = [{ browser: "safari", visitors: 1260, fill: "#3F5E3E" }];
...
// export function GarmentSoldChart() {
//   return (
...
//         <CardTitle className="font-bold text-lg">Garments Sold</CardTitle>
//         <CardDescription className="text-sm">
//           on Mud Patch marketplace
//         </CardDescription>
//       </CardHeader>
